...
(async function () {
	...
	model = await tf.loadModel('https://skincanceranalyzer.s3.ap-south-1.amazonaws.com/model/model.json');
	$("#selected-image").attr("src", "http://skincanceranalyzer.s3.ap-south-1.amazonaws.com/assets/alt_icon.jpg");
